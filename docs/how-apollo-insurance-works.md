...
| **SRE (spread related earnings)** | Management's operating measure of the engine's quarterly profit: investment earnings + strategic fees − cost of funds − opex − financing. It strips market noise (realized/unrealized swings) — useful for trend, but remember what it excludes: credit losses flow through it only as yield, never as a provision line. The margin version (SRE ÷ average net invested assets) dropped below 1% for the first time in 1Q26. |
| **Cost of funds** | What the float costs, all-in: crediting rates on annuities plus coupons on funding agreements, as a % of average net invested assets. The repricing race that decides the spread: Athene's cost of funds climbed to 3.79% and stayed there while the earned rate rolled over — the −31bp spread compression of the past year is that race being lost, quarter by quarter. |
