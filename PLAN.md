...
- 2026-07-22 · parity round 2 (stop-gate) · AEL 2023+2024 era-2 Schedule D through the parser — BOTH FOOT TO THE DOLLAR, zero exceptions (5,199/5,203 rows; BACV 37,602,643,077 / 38,063,028,918) · AEL 3-year features: PL 9.4→14.2→9.7% (no Athene ramp — measured control), below-IG 2.6→3.6→5.1%, age 4.7→4.3→4.0y · aging+concentration tools parameterized, run ×3 AEL years (Athene regression clean) · top name = BROOKFIELD SECURITIZATION CFO $423M (affiliate fingerprint at 1/9th Athene's weight) · ENGINE WORKBOOKS ×3 (bnt-quarterly 87 checks incl quarterly↔FY cross-gates; aspida-annual 33; klr-annual 20 — 140 checks, 0 fail, python-verified) · new findings: KLR negative equity 2022–23; $80M misprint in klr-fs-2025 caught by footing; BNT DOE metronome vs GAAP tape; Aspida breakeven-by-contributions · dashboards + comparison republished with trends.
